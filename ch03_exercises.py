...
# inner, who would you invite? Make a list that includes at least three 
...
# invitations. You’ll have to think of someone else to invite. Start 
# with your program from Exercise 3-4. Add a print() call at the end of 
# your program, stating the name of the guest who can’t make it. Modify 
# your list, replacing the name of the guest who can’t make it with the 
# name of the new person you are inviting. Print a second set of 
...
# table. Use insert() to add one new guest to the beginning of your 
# list. Use insert() to add one new guest to the middle of your list. 
...
# only two guests. Start with your program from Exercise 3-6. Add a new 
# line that prints a message saying that you can invite only two people 
# for dinner. Use pop() to remove guests from your list one at a time 
# until only two names remain in your list. Each time you pop a name 
# from your list, print a message to that person letting them know 
# you’re sorry you can’t invite them to dinner. Print a message to each 
# of the two people still on your list, letting them know they’re 
# still invited. Use del to remove the last two names from your list, 
# so you have an empty list. Print your list to make sure you actually 
...
def ex3_7():
    ...
    while len(invitees) > 2:
        print(f"{invitees.pop().title()}, I'm sorry I can't have you over for "
            "dinner. Maybe next time?")

    print()
    print_invitations(invitees)

# 3-8. Seeing the World: Think of at least five places in the world 
# you’d like to visit. Store the locations in a list. Make sure the 
# list is not in alphabetical order. Print your list in its original 
# order. Don’t worry about printing the list neatly; just print it as a 
# raw Python list. Use sorted() to print your list in alphabetical 
# order without modifying the actual list. Show that your list is still 
# in its original order by printing it. Use sorted() to print your list 
# in reverse-alphabetical order without changing the order of the 
# original list. Show that your list is still in its original order by 
# printing it again. Use reverse() to change the order of your list. 
# Print the list to show that its order has changed. Use reverse() to 
# change the order of your list again. Print the list to show it’s back 
# to its original order. Use sort() to change your list so it’s stored 
# in alphabetical order. Print the list to show that its order has been 
# changed. Use sort() to change your list so it’s stored in 
# reverse-alphabetical order. Print the list to show that its order has 
# changed. 
def ex3_8():
...
# example, you could make a list of mountains, rivers, countries, 
...
# one of your programs to produce an index error. Make sure you correct 
