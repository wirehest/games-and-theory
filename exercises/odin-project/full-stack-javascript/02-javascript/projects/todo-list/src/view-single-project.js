...
function makeProjectCardTodos(project, projectIndex) {
  ...
  project.todos.forEach((todo, i) => {
    ...
    let todoIsComplete = projects.at(projectIndex).getTodo(i).isComplete;
    ...
    let extrasVisible = projects.at(projectIndex).getTodo(i).extrasVisible;
    ...
    collapseLabel.textContent = 'Description & Priority';
