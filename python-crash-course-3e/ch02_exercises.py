...
# the famous person’s name using a variable called famous_person. Then 
...
# and include some whitespace characters at the beginning and end of 
# the name. Make sure you use each character combination, "\t" and 
# "\n", at least once. Print the name once, so the whitespace around 
# the name is displayed. Then print the name using each of the three 
...
# variable called filename. Then use the removesuffix() method to 
# display the filename without the file extension, like some file 
# browsers do. 
def ex2_8():
...
# 2-11. Adding Comments : Choose two of the programs you’ve written, 
