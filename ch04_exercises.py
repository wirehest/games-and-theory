...
# the name of each pizza. Modify your for loop to print a sentence using 
...
# statement like I like pepperoni pizza. Add a line at the end of your 
# program, outside the for loop, that states how much you like pizza. 
# The output should consist of three or more lines about the kinds of 
# pizza you like and then an additional sentence, such as I really love 
# pizza!
def ex4_1():
...
# program to print a statement about each animal, such as A dog would 
# make a great pet. Add a line at the end of your program, stating what 
# these animals have in common. You could print a sentence, such as 
...
# several lines to the end of the program that do the following: Print 
# the message The first three items in the list are:. Then use a slice 
# to print the first three items from that program’s list. Print the 
# message Three items from the middle of the list are:. Then use a slice 
# to print three items from the middle of the list. Print the message 
# The last three items in the list are:. Then use a slice to print the 
...
# friend_pizzas. Then, do the following: Add a new pizza to the original 
# list. Add a different pizza to the list friend_pizzas. Prove that you 
# have two separate lists. Print the message My favorite pizzas are:, 
...
# second list. Make sure each new pizza is stored in the appropriate 
# list. 
def ex4_11():
    pizzas = ['cheese', 'hawaiian', 'pepperoni']
...
# avoided using for loops when printing, to save space. Choose a version 
...
# changes its menu, replacing two of the items with different foods. Add 
# a line that rewrites the tuple, and then use a for loop to print each 
...
# https://python.org/dev/pepspep-0008. You won’t use much of it now, but 
# it might be interesting to skim through it. 
def ex4_14():
    pass

# 4-15. Code Review: Choose three of the programs you’ve written in this 
# chapter and modify eachone to comply with PEP 8. Use four spaces for 
# each indentation level. Set your text editor to insert four spaces 
# every time you press the TAB key, if you haven’t already done so (see 
# Appendix B for instructions on how to do this). Use less than 80 
# characters on each line, and set your editor to show a vertical 
